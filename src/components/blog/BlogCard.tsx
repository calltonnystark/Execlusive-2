...
export function BlogCard({ post }: BlogCardProps) {
  ...
  const mediumUrl =
    'https://medium.com/@usmansamar.live/self-hosting-openclaw-2439f4f257a5';
  const postUrl = slug.startsWith('OpenClaw on AWS EC2')
    ? mediumUrl
    : `/blog/${slug}`;
  const isExternalPost = postUrl.startsWith('https://');
